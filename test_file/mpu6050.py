...
while True:
	...
	print "Gx=%.2f" %Gx, u'\u00b0'+ "/s", "\tGy=%.2f" %Gy, u'\u00b0'+ "/s", "\tGz=%.2f" %Gz, u'\u00b0'+ "/s", "\tAx=%.2f g" %Ax, "\tAy=%.2f g" %Ay, "\tAz=%.2f g" %Az, "\tT=%.2f " %temp, u'\u00b0'+"C"
	...
	if Ax>0.75:
		print "Accident due to Ax1"
	if Ax<-0.75:
		print "Accident due to Ax2"
	if Ay>0.75:
		print "Accident due to Ay1"		
	if Ay<-0.75:
		print "Accident due to Ay2"
